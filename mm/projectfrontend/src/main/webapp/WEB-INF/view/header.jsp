...
<div class="navbar-header">
				<a href="" class="navbar-brand"><img src="<c:url value='/resources/images/logo.jpg'></c:url>" alt="PHARM EASY" height="30px" width="60px"></a>
...
<li><a href="<c:url value='/all/getallproducts'></c:url>">Browse all products</a></li>
  <li class="dropdown"><a href="#" class="dropdown-toggle"
				...
				<li><a href="#">Compressed Tablets</a></li>
				<li><a href="#">Sugar-Coated Tablets</a><li>
				<li><a href="#">Effervescent Tablets</a></li>
				<li><a href="#">Sublingual Tablets</a></li>
				<li><a href="#">Enterix Coated Tablets</a><li>
